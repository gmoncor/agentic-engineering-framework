...
5. Si el usuario interrumpe la sesion a mitad de una plantilla, los ficheros ya escritos se quedan como estan. Puede relanzar esta guia mas tarde: el paso 2 detecta que ya existe y permite retomar desde donde se quedo.
6. Al terminar, presenta un resumen de los ficheros creados o actualizados en `ai_docs/core/` y sugiere continuar con la planificacion de specs y tasks.
