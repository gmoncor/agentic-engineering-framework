...
El usuario ejecuta `/implementar-spec` para implementar todas las tasks de la spec. El comando agrupa las tasks en oleadas por dependencias: tasks independientes van juntas, tasks con dependencias esperan a sus prerequisitos. `/implementar` sigue disponible para control manual de una task individual.
