---
description: "Guia el bootstrap inicial de ai_docs/core/ — lee las 4 plantillas y conduce la conversacion para generar vision, planificacion, roadmap y setup de testing"
---
...
5. Si el usuario interrumpe la sesion a mitad de una plantilla, los ficheros ya escritos se quedan como estan. Puede relanzar `/inicio` mas tarde: el paso 2 detecta que ya existe y permite retomar desde donde se quedo.
6. Al terminar, presenta un resumen de los ficheros creados o actualizados en `ai_docs/core/` y sugiere `/planificar` como siguiente paso.
